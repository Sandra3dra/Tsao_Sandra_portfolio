<header id="mainHeader">
    <svg id="phone_icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 41"><defs><style>.cls-1{fill:#434345;}</style></defs><title>phone</title><path class="cls-1" d="M10.1.64c.73.61.75,1.36,1.08,2.53a17.93,17.93,0,0,0,2.13,4.5c.64,1,1,1.33,1,2a3.2,3.2,0,0,1-1.2,2.17c-1.91,1.8-3.18,1.25-4.28,2.28s-.13,2.65.36,3.72c.74,1.46,2.09,3.84,4.1,7.15a20,20,0,0,0,5.11,5.11,4.44,4.44,0,0,0,3.07,1,3.74,3.74,0,0,0,2.05-1,11.14,11.14,0,0,1,2.05-2.05c.87-.66,1.35-1,2.05-1a2.92,2.92,0,0,1,2,1c.63.69.48,1.11,1,2.05a6.61,6.61,0,0,0,2,2c1.75,1.27,2.72,1.09,3.07,2a3.08,3.08,0,0,1,0,2l0,.1a9.23,9.23,0,0,1-5.11,4.08,13.45,13.45,0,0,1-8.19,0C14.43,37.88,7.25,28.2,7.16,28.09S1.94,21.73,0,10.73c0,0-.31-5.84,4.09-9.19C4.59,1.16,6.63-.32,8.75.06A3,3,0,0,1,10.1.64Z" transform="translate(0 0)"/></svg>
    <a href="/index.php" id="logoA"><img id="logo" src="/public/images/sandra_tsao.svg" alt="sandra tsao logo"></a>
    <div class="mainNavCon">
        <svg id="hamburger_menu" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 32"><defs><style>.cls-1, .cls-2, .cls-3{fill:#434345;}</style></defs><title>Artboard 1</title><rect class="cls-1 cls-2" y="13" width="40" height="6" rx="2"/><rect class="cls-1" width="40" height="6" rx="2"/><rect class="cls-3" y="26" width="40" height="6" rx="2"/></svg>
